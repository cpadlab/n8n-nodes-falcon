...
/**
 * Comprehensive unit test suite for executeRuntimeDetections operations.
 */
describe('executeRuntimeDetections', () => {
	...
	it('should throw an error for unsupported operation', async () => {
		...
		it("should execute 'getRuntimeDetectionsCombinedV2' operation with default parameters successfully", async () => {
			const mockContext: any = {
		...
		it("should execute 'getRuntimeDetectionsCombinedV2' operation with non-empty parameters successfully", async () => {
			const mockContext: any = {
				getNodeParameter: jest.fn((paramName: string, index: number, fallback?: any) => {
					if (paramName === 'operation') return 'getRuntimeDetectionsCombinedV2';
