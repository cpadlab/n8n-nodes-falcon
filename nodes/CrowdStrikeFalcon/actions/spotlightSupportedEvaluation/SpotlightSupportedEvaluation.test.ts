...
/**
 * Comprehensive unit test suite for executeSpotlightSupportedEvaluation operations.
 */
describe('executeSpotlightSupportedEvaluation', () => {
	...
	it('should throw an error for unsupported operation', async () => {
		...
		it("should execute 'combinedSupportedEvaluationExt' operation with default parameters successfully", async () => {
			const mockContext: any = {
		...
		it("should execute 'combinedSupportedEvaluationExt' operation with non-empty parameters successfully", async () => {
			const mockContext: any = {
				getNodeParameter: jest.fn((paramName: string, index: number, fallback?: any) => {
					if (paramName === 'operation') return 'combinedSupportedEvaluationExt';
