...
/**
 * Comprehensive unit test suite for executeCloudSecurityAssets operations.
 */
describe('executeCloudSecurityAssets', () => {
	...
	it.each([
		'cloudSecurityAssetsCombinedApplicationFindings',
		'cloudSecurityAssetsCombinedComplianceByAccount',
		'cloudSecurityAssetsEntitiesGet',
		'cloudSecurityAssetsEntitiesPost',
