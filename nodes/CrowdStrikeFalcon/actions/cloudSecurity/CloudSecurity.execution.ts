...
async function handleListCloudGroupIDsExternal(c: IExecuteFunctions, i: number, fc: FalconClient): Promise<any> {
	...
	const filter = c.getNodeParameter('filter', i, '') as string;
	const sort = c.getNodeParameter('sort', i, '') as string;
	const offset = (typeof c.getNodeParameter('offset', i, 0) === 'object' ? JSON.stringify(c.getNodeParameter('offset', i, 0)) : (typeof c.getNodeParameter('offset', i, 0) === 'object' ? JSON.stringify(c.getNodeParameter('offset', i, 0)) : String(c.getNodeParameter('offset', i, 0))));
	const limit = (typeof c.getNodeParameter('limit', i, 100) === 'object' ? JSON.stringify(c.getNodeParameter('limit', i, 100)) : (typeof c.getNodeParameter('limit', i, 100) === 'object' ? JSON.stringify(c.getNodeParameter('limit', i, 100)) : String(c.getNodeParameter('limit', i, 100))));
