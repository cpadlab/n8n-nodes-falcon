...
export const deviceControlWithBluetoothOperations: INodeProperties[] = [
	createOperationField('deviceControlWithBluetooth', [
...
export const deviceControlWithBluetoothFields: INodeProperties[] = [
	createIdsField('deviceControlWithBluetooth', ['getDeviceControlPoliciesV2']),
	createBodyJsonField('deviceControlWithBluetooth', ['patchDeviceControlPoliciesClassesV1',
