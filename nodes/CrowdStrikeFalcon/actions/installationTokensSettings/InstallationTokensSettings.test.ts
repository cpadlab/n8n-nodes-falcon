...
/**
 * Comprehensive unit test suite for executeInstallationTokensSettings operations.
 */
describe('executeInstallationTokensSettings', () => {
	...
	it('should throw an error for unsupported operation', async () => {
		...
		it("should execute 'customerSettingsUpdate' operation with default parameters successfully", async () => {
			const mockContext: any = {
		...
		it("should execute 'customerSettingsUpdate' operation with non-empty parameters successfully", async () => {
			const mockContext: any = {
				getNodeParameter: jest.fn((paramName: string, index: number, fallback?: any) => {
					if (paramName === 'operation') return 'customerSettingsUpdate';
