...
/**
 * Comprehensive unit test suite for executeCloudSecurityRisks operations.
 */
describe('executeCloudSecurityRisks', () => {
	...
	it('should throw an error for unsupported operation', async () => {
		...
		it("should execute 'cloudSecurityTimelineRisksEnriched' operation with default parameters successfully", async () => {
			const mockContext: any = {
		...
		it("should execute 'cloudSecurityTimelineRisksEnriched' operation with non-empty parameters successfully", async () => {
			const mockContext: any = {
				getNodeParameter: jest.fn((paramName: string, index: number, fallback?: any) => {
					if (paramName === 'operation') return 'cloudSecurityTimelineRisksEnriched';
