...
/**
 * Comprehensive unit test suite for executeCloudAwsRegistration operations.
 */
describe('executeCloudAwsRegistration', () => {
	...
	it.each([
		'cloudRegistrationAwsCreateAccount',
		'cloudRegistrationAwsDeleteAccount',
		'cloudRegistrationAwsGetAccounts',
		'cloudRegistrationAwsQueryAccounts',
		'cloudRegistrationAwsTriggerHealthCheck',
		'cloudRegistrationAwsUpdateAccount',
		'cloudRegistrationAwsValidateAccounts'
