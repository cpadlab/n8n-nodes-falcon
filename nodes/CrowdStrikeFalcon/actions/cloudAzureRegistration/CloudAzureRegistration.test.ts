...
/**
 * Comprehensive unit test suite for executeCloudAzureRegistration operations.
 */
describe('executeCloudAzureRegistration', () => {
	...
	it.each([
		...
		'cloudRegistrationAzureDeleteRegistration',
		...
		'cloudRegistrationAzureGetScript',
		'cloudRegistrationAzureGetScriptVersions',
		...
		'cloudRegistrationAzureValidateRegistration'
