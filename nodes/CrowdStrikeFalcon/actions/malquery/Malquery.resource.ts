...
export const malqueryFields: INodeProperties[] = [
	...
	createIdsField('malquery', ['getMalQueryDownloadV1', 'getMalQueryMetadataV1', 'getMalQueryRequestV1']),
	createBodyJsonField('malquery', ['postMalQueryEntitiesSamplesMultidownloadV1',
