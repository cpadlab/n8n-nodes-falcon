...
/**
 * Comprehensive unit test suite for executeIdentityProtection operations.
 */
describe('executeIdentityProtection', () => {
	...
	it.each([
		'apiPreemptProxyDeletePolicyRules',
		'apiPreemptProxyGetPolicyRules',
		'apiPreemptProxyGetPolicyRulesQuery',
		'apiPreemptProxyPostGraphql',
		'apiPreemptProxyPostPolicyRules'
